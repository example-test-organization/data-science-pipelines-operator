...
git remote add ${GH_USER_NAME} https://${GH_USER_NAME}:${GH_TOKEN}@github.com/${GH_USER_NAME}/${{ env.DSPO_REPOSITORY }}.git
...
echo "Confirmed existence of ${MINOR_RELEASE_BRANCH} in compatibility.yaml."
