...
check_branch_exists(){
  ...
  echo "Confirmed Branch ${2} does not exist in GH Repo ${1}"
}

check_branch_exists ${DSPO_REPOSITORY_FULL} ${MINOR_RELEASE_WILDCARD}
check_branch_exists ${DSP_REPOSITORY_FULL} ${MINOR_RELEASE_WILDCARD}
