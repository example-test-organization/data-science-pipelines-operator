...
* DSP component for ${TARGET_VERSION_TAG} can be found [here](https://github.com/${REPOSITORY}/releases/tag/${TARGET_VERSION_TAG})
* DSPO component for ${TARGET_VERSION_TAG} can be found [here](https://github.com/${REPOSITORY}/releases/tag/${TARGET_VERSION_TAG})
