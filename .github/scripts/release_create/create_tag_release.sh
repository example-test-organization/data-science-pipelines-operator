...
* DSP component for ${TARGET_VERSION_TAG} can be found [here](https://github.com/opendatahub-io/data-science-pipelines/releases/tag/${TARGET_VERSION_TAG})
* DSPO component for ${TARGET_VERSION_TAG} can be found [here](https://github.com/opendatahub-io/data-science-pipelines-operator/releases/tag/${TARGET_VERSION_TAG})

Version Table for components can be found [here](https://github.com/opendatahub-io/data-science-pipelines-operator/blob/main/docs/release/compatibility.md)
EOF
